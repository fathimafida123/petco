...
//   return (
//     <div style={{background:"#F2EFE7"}} className='min-h-screen'>
//       <h1 className='text-[#006A71] text-2xl p-2 font-bold mb-6'>Dashboard</h1>
// <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5'>
//     <div className='bg-[#9ACBD0] p-5 routnded-lg shadow text-white rounded-lg'>
//         <h2 className='text-lg font-serif'>products</h2>
//         <p className='text-3xl font-bold mt-2'>{product}</p>
//     </div>

//     <div style={{background:'#9ACBD0'}} className='  p-5 rounded-lg shadow text-white'>
...
//     </div>
//     <div  style={{background:'#9ACBD0'}}  className=' rounded-xl p-5 shadow text-white'>
...
//         <div style={{background:'#9ACBD0'}} className=' p-5 rounded-xl shadow text-white'>
...
//         <div style={{background:'#9ACBD0'}} className=' p-5 shadow rounded-xl text-black'>
...
//   <h2 className="text-xl font-semibold mb-4 text-gary-950">
//     Revenue Overview
//   </h2>
// <div>
//   <button onClick={()=>setRevenueType("weekly")}className={`px-4 py-2 rounded-md ${revenueType==='weekly'?"bg-gray-800 text-white":" bg-white/90 shadow"}`}>Weekly</button>
//   <button onClick={()=>setRevenueType("monthly")}className={`px-4 py-2 rounded-md ${revenueType==="monthly"? "bg-gray-800 text-white" : "bg-white/90 shadow"}`}>Monthly</button>
// </div>
// <ResponsiveContainer width="100%" height={300}>
//   <AreaChart data={revenueType === "weekly" ? weeklyData : monthlyData}>
...
//                 <table className='w-full min-w-[700px]  text-white border-1 border-black '>
